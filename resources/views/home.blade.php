    ...
    <body>
        ...
        <section id="menu" class="menu">
            ...
            <div class="row">
                ...
                @if($promo->enabled==1)
                    <div class="menu-card">
                    <img src="{{$promo->image}}" width="100%" height="100%" alt="" class="img-fluid" style="height: 250px;">
                        <h3 class="menu-card-title">- {{ $promo->title }} -</h3>
                        <p> {{ $promo->promo }} </p>
                        <p class="menu-card-price">Rp. {{ number_format($promo->price) }}</p>
                    </div>
                @endif
                @endforeach
                @endif
        ...
        <section id="contact" class="contact">
            ...
            <div class="row">
                @forelse ($contact as $contact)
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15955.822677878356!2d116.8842081!3d-1.1914791!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df1497cad8de225%3A0xd4f4e0a05de1352a!2sKilo%20Kopi!5e0!3m2!1sen!2sid!4v1698243445720!5m2!1sen!2sid" allowfullscreen="" loading="lazy"
