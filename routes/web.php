...
Route::post('/AddKuisioner', [KuisionerController::class, 'store']);
...
Route::middleware('auth')->group(function () {
    ...
    //K-Pro Team Dashboard
    Route::get('/ourteam', [OurTeamController::class, 'index']);
    Route::get('/ourteam/create', [OurTeamController::class, 'create']);
    Route::post('/ourteam/store', [OurTeamController::class, 'store']);
    Route::get('/ourteam/edit/{ourteam}', [OurTeamController::class, 'edit']);
    Route::put('/ourteam/update/{ourteam}', [OurTeamController::class, 'update']);
    Route::delete('/ourteam/delete/{ourteam}', [OurTeamController::class, 'delete']);

    //K-Pro About Dashboard
    ...
    Route::delete('/ourteamdelete/{about}', [AboutController::class, 'delete']);
});
//K-Pro Dashboard Product
